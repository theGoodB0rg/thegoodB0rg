...
### Top Languages
C++ (45.5%), Kotlin (17.7%), TypeScript (13.7%), JavaScript (8.8%), CSS (3.2%), PHP (2.5%), Java (2.5%), SCSS (1.9%)

### Detected Stacks
GitHub Actions (CI/CD) ×8, Frontend Tooling ×7, React ×5, JVM ×4, Next.js ×1, Python ×1, Vue ×1
...
_Last updated: 2026-07-05 06:41 UTC_
