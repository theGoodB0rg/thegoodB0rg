...
### Top Languages
Kotlin (36.8%), TypeScript (24.0%), JavaScript (17.5%), CSS (6.5%), PHP (5.3%), Java (4.2%), SCSS (4.0%), HTML (1.2%)

### Detected Stacks
GitHub Actions (CI/CD) ×7, Frontend Tooling ×5, React ×4, JVM ×3, Next.js ×1, Python ×1
...
_Last updated: 2026-01-29 03:49 UTC_
