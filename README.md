...
### Top Languages
C++ (44.9%), Kotlin (17.4%), TypeScript (13.8%), JavaScript (8.7%), CSS (3.1%), PHP (2.5%), Java (2.5%), Python (2.4%)

### Detected Stacks
GitHub Actions (CI/CD) ×8, Frontend Tooling ×7, React ×5, JVM ×4, Python ×2, Next.js ×1, Vue ×1
